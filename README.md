...
<preference name="SplashFullscreen" value="true|false" />
```
...
"SplashFullscreen" perference is optional and defaults to false. If set true splash screen is fullscreen and the main app is not.
